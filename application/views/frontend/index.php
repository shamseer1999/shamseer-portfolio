...
<body>
  ...
  <!-- ======= Hero Section ======= -->
  <div id="hero" class="hero route bg-image" style="background-image: url(<?=base_url('assets/img/shamseer-img2.png')?>)">
    <div class="overlay-itro"></div>
    <div class="hero-content display-table">
      <div class="table-cell">
        <div class="container">
          <!--<p class="display-6 color-d">Hello, world!</p>-->
          <h1 class="hero-title mb-4">I am Shamseer, Art of Software Crafting</h1>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="row">
                    <div class="col-sm-6 col-md-5">
                      <div class="about-img">
                        <img src="<?=base_url('assets/img/shamseer.jpg')?>" class="img-fluid rounded b-shadow-a" alt="">
                      </div>
                    </div>
                    <div class="col-sm-6 col-md-7">
                      <div class="about-info">
                        <p><span class="title-s">Name: </span> <span>Shamseer Tt</span></p>
                        <p><span class="title-s">Profile: </span> <span>Full Stack Developer</span></p>
                        <p><span class="title-s">Email: </span> <span>shamseertt29@gmail.com</span></p>
                        <p><span class="title-s">Phone: </span> <span>9539406750</span></p>
                        <p><span class="title-s">Github: </span> <span><a href="https://github.com/shamseer1999" class="text-primary">shamseer-tt</a></span></p>
                        <p><span class="title-s">Linkdin: </span> <span><a href="https://www.linkedin.com/in/shamseer-tt-1320a51a9/" class="text-primary">shamseer</a></span></p>
                      </div>
                    </div>
                  </div>
                  <!-- <div class="skill-mf">
                ...
                <div class="col-md-6">
                  <div class="about-me pt-4 pt-md-0">
                    ...
                    <p class="lead">
                    Greetings! I'm Shamseer, an IT professional specializing in software development. I wear the hat of a software developer,
                     proficient in PHP, Python, and JavaScript. My passion lies in crafting digital solutions that marry creativity with 
                     functionality. Let's journey through my portfolio and witness how code can transform ideas into impactful realities.
                    </p>
                    <!-- <p class="lead">
                    My toolkit includes a variety of languages, each chosen with a purpose: PHP for dynamic web applications that breathe life
                     into online experiences, Python for its versatility and power in problem-solving, and JavaScript for creating interactive and
                      engaging front-end interfaces. I believe in the art of coding as much as the science, and I take pride in my ability to
                       create clean, efficient, and maintainable code.
                    </p> -->
                    <p class="lead">
                    Every project I undertake is an opportunity to learn, grow, and push the boundaries of what's possible in the digital realm. From
                     transforming concepts into lines of code to seeing those lines evolve into functional, impactful applications, I find immense
                      satisfaction in every step of the development process.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="title-box text-center">
              ...
              <p class="subtitle-a">
              Empowering Solutions: Explore My Offered Services
              </p>
          ...
          <div class="col-md-4">
            <div class="service-box">
              ...
              <div class="service-content">
                ...
                <p class="s-description text-center">Elevating ideas through pixels and code. Welcome to my portfolio, where each website is a canvas and every click is an
                   experience. Join me in exploring the art of web design.
                </p>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="service-box">
              ...
              <div class="service-content">
                ...
                <p class="s-description text-center">Transforming Lines of Code into Seamless Online Experiences. Explore my portfolio showcasing the fusion of creativity and functionality in web development.
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="service-box">
              ...
              <div class="service-content">
                ...
                <p class="s-description text-center">Journey through my Graphic Design Portfolio, where every artwork is a fusion
                   of creativity and precision, inviting you to discover the world of visual storytelling.
                </p>
              </div>
            </div>
          </div>
            ...
            <div class="testimonials-slider swiper" data-aos="fade-up" data-aos-delay="100">
              <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                  <div class="testimonial-box">
                    <div class="author-test">
                      <img src="<?=base_url('assets/img/testimonial-2.jpg')?>" alt="" class="rounded-circle b-shadow-a">
                ...
                <div class="swiper-slide">
                  <div class="testimonial-box">
                    <div class="author-test">
                      <img src="<?=base_url('assets/img/testimonial-4.jpg')?>" alt="" class="rounded-circle b-shadow-a">
